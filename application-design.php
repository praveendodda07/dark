...
<head>
    ...
    <title>Application Development | Af Ad Agency</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="row d-flex align-items-center">
                <div class="col-md-12 col-12">
                    <div class="banner_content">
                        <br>
                        <h1 class="banner_title">Application Development</h1>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-content mb-all-40">
                        ...
                        <p class="mb-15">
                            World’s most used mobile platform – Android- is ideal for Custom
                            Android app design & development due to its versatile Android
                            Software Development Kit (SDK). Android SDK enables usage of
                            multiple code languages like Kotlin, Java, C++, lending it a universal
                            applicability. Our Android app developers ensure better stability and
                            functionality to your business by designing native applications in
                            sync with your business model. We design mobile applications
                            following Android Material Design concepts. Our native app
                            development methodology always prunes down the cost of android
                            app development.
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="single-banner zoom">
                        <a><img src=" assets/images/services/mobileapp-1.jpg" alt="banner-img"></a>
                    </div>
    ...
    <div class="skill-area ptb-10" style="background-color: whitesmoke;">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="single-banner zoom">
                        <a><img src=" assets/images/services/mobileapp-2.png" alt="banner-img"></a>
                    </div>
                    <!-- Single Bannner End Here -->
                </div>
                <div class="col-lg-6">
                    <div class="about-content mb-all-40">
                        ...
                        <p class="mb-15">
                            iOS is the safest operating system available for electronic devices to
                            protect your app activities and personal and professional
                            information. Being the most stable Mobile OS, iOS is one of the
                            preferable OS after Android. Analytics shows that there are more
                            than 2 million apps available in App Store with a notable installation
                            count. . iOS app development is a complex process that is managed
                            by experts to bring awesome results. Its niche functionalities and
                            features make iOS a go-to platform for developers. iOS app
                            development is the most important and peculiar task that should be
                            handled with intelligence. The overall demand for iOS apps is neverending that’s why making iOS apps for your business needs is
                            necessary.
                        </p>
                    </div>
